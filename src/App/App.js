...
const links = [
  {
    ...
    label: 'Выбрать пиццу',
    className: 'pizza',
    img: {backgroundImage : 'URL(' + require('./img/pizzamenu.jpg') + ')'}
  },
  {
    link: '/salad',
    label: 'Выбрать закуски',
    className: 'salad',
    img: {backgroundImage : 'URL(' + require('./img/saladmenu.jpg') + ')'}
  },
  {
    link: '/drink',
    label: 'Выбрать напитки',
    className: 'drink',
    img: {backgroundImage : 'URL(' + require('./img/drinkmenu.jpg') + ')'}
  },
  {
    link: '/order',
    label: 'Оформить заказ',
    className: 'order',
    img: {backgroundImage : 'URL(' + require('./img/ordermenu.jpg') + ')'}
  ...
  render() {
    ...
    return (
		<Router>
			<div className="App">
				<Header />
				<Route exact path="/hello-world" component={() => (<HeroSlider items={pizzas} links={links} onAdd={this.onAdd} />)} />
